...
public class OrangeHRMSupervisor {
...
@BeforeSuite
	...
	@Test
	public void Supervisor() throws InterruptedException, IOException
	{
		obj.login(dr, props.getProperty("super_uname"), props.getProperty("super_pass"));//Aryan12
     	obj.assignLeave(dr);
